...
/**
 * A {@link Pump} is a machine that removes toxicity from a
 * {toxiccleanup.builder.entities.tiles.ToxicField}
...
public class Pump extends GameEntity implements Powered {
     ...
     * Initialises an animation timer that fires every 4 ticks and
     * a pump timer that fires every 100 ticks.
     * The given Adjustable is the target whose value is reduced by 1 each
     * time the pump timer fires (provided sufficient power is available).
     *
     ...
     * Pump's animation and pumping action only proceeds when power >= 2
     *
     * @return 2, minimum power level for pump to operate
     * @stage3
     */
    @Override
